...
public class SetServerIntAttributeCommand extends AbstractServerCommand {
    protected int newValue;

    protected int oldValue;

    public SetServerIntAttributeCommand(String label, IServerWorkingCopy curServer, String key, int value) {
    ...
    public IStatus execute(IProgressMonitor mon, IAdaptable adaptable) throws ExecutionException {
        ...
        try {
            oldValue = curServer.getAttribute(key, oldValue);
