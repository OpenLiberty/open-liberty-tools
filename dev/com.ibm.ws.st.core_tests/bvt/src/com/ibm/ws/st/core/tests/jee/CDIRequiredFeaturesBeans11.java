...
public class CDIRequiredFeaturesBeans11 extends CDIRequiredFeaturesBase {
    private static final String TEST_NAME = CDIRequiredFeaturesBeans11.class.getSimpleName();
    ...
    public static TestSuite suite() {
        ...
        suite.addTest(CDIRequiredFeaturesBeans11.getOrderedTests());
        suite.setName(CDIRequiredFeaturesBeans11.class.getSimpleName());
        return suite;
    }
    ...
    public static TestSuite getOrderedTests() {
        ...
        testSuite.addTest(TestSuite.createTest(CDIRequiredFeaturesBeans11.class, "doSetup"));
        testSuite.addTest(TestSuite.createTest(CDIRequiredFeaturesBeans11.class, "testAddApp"));
        testSuite.addTest(TestSuite.createTest(CDIRequiredFeaturesBeans11.class, "testFeaturesAdded"));
        testSuite.addTest(TestSuite.createTest(CDIRequiredFeaturesBeans11.class, "doTearDown"));
