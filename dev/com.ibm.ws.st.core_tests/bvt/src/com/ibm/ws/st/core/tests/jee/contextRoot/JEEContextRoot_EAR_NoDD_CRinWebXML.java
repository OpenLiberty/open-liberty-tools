...
public class JEEContextRoot_EAR_NoDD_CRinWebXML extends JEETestBase {

    public static TestSuite suite() {
        TestSuite suite = new TestSuite();
        suite.addTest(JEEContextRoot_EAR_NoDD_CRinWebXML.getOrderedTests());
        suite.setName(JEEContextRoot_EAR_NoDD_CRinWebXML.class.getSimpleName());
        return suite;
    }
    ...
    public static TestSuite getOrderedTests() {
        ...
        testSuite.addTest(TestSuite.createTest(JEEContextRoot_EAR_NoDD_CRinWebXML.class, "doSetup"));
        testSuite.addTest(TestSuite.createTest(JEEContextRoot_EAR_NoDD_CRinWebXML.class, "testContextRoot"));
        testSuite.addTest(TestSuite.createTest(JEEContextRoot_EAR_NoDD_CRinWebXML.class, "doTearDown"));
    ...
    public void doSetup() throws Exception {
        print("Starting test: JEEContextRoot_EAR_NoDD_CRinWebXML");
        init();
        createRuntime();
        createServer();
        createVM();
    ...
    public void doTearDown() throws Exception {
        ...
        wait("Ending test: JEEContextRoot_EAR_NoDD_CRinWebXML\n", 5000);
    }
}