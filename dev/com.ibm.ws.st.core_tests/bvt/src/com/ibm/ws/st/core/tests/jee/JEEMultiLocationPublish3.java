...
@TestCaseDescriptor(description = "Test publish of applications in various locations - switch loose config mode", isStable = true)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class JEEMultiLocationPublish3 extends JEETestBase {

    private static final String resourceLoc = "jee/JEEMultiLocationPublish";

    public String getClassName() {
        return JEEMultiLocationPublish3.class.getSimpleName();
    }
    ...
    @Test
    public void test3_switchLooseCfg() throws Exception {
        switchconfig(!wsServer.isLooseConfigEnabled());
        wait("Wait 3 seconds before ping.", 3000);
        testPingWebPage("WebA/WebAServlet", "WebA");
    }

    @Test
    public void test4_addOtherApps() throws Exception {
        addApps("WorkspaceEAR", "EARD");
        wait("Wait 3 seconds before ping.", 3000);
        testPingWebPage("WebA/WebAServlet", "WebA");
    ...
    @Test
    public void test5_switchLooseCfg() throws Exception {
        switchconfig(!wsServer.isLooseConfigEnabled());
        wait("Wait 3 seconds before ping.", 3000);
        testPingWebPage("WebA/WebAServlet", "WebA");
        testPingWebPage("WebB/WebBServlet", "WebBServlet UtilA UtilB");
