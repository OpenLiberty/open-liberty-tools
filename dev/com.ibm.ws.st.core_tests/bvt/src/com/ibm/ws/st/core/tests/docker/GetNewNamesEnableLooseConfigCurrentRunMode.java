...
/**
 * This test simulates getting new names when loose config is enabled while in run mode
 *
 * This test simulates getting new names when the docker server is restarted and loose config is already turned on
 */
public class GetNewNamesEnableLooseConfigCurrentRunMode extends GetNewNames {

    /**
     *
     */
    public GetNewNamesEnableLooseConfigCurrentRunMode() {
        // Empty
    }
    ...
    public static void printHeader() {
        System.out.println("=====================================================================================================");
        System.out.println("Tests getting new names when changing to loose config while in run mode.");
        System.out.println("Tests getting new names when restarting the server while loose config is already turned on.");
        System.out.println("=====================================================================================================");
    }
    ...
    public void test001() throws Exception {
        ...
        String expectedContainerName = "wlp_dev_run";
        String expectedImageName = "wlp_dev_run_";
    ...
    public void test002() throws Exception {
        ...
        existingContainers.add("wlp_dev_run");
        doNewNameTest("wlp", "wlp-1_dev_run", "wlp-1_dev_run_");
    }
    ...
    public void test003() throws Exception {
        ...
        // Add "existing" name that is in conflict with the initial proposed container name.
        existingContainers.add("wlp_dev_run");
        existingContainers.add("wlp-1_dev_run");
        doNewNameTest("wlp", "wlp-2_dev_run", "wlp-2_dev_run_");
    }
    ...
    public void test004() throws Exception {
        ...
        doNewNameTest("wlp1", "wlp1_dev_run", "wlp1_dev_run_");
    }
    ...
    public void test005() throws Exception {
        ...
        // Add "existing" name that is in conflict with the initial proposed container name.
        existingContainers.add("wlp1_dev_run");
        doNewNameTest("wlp1", "wlp1-1_dev_run", "wlp1-1_dev_run_");
    }
    ...
    public void test006() throws Exception {
        ...
        // Add "existing" name that is in conflict with the initial proposed container name.
        existingContainers.add("wlp1_dev_run");
        existingContainers.add("wlp1-1_dev_run");
        doNewNameTest("wlp1", "wlp1-2_dev_run", "wlp1-2_dev_run_");
    }
    ...
    public void test007() throws Exception {
        ...
        existingContainers.add("foo");
        doNewNameTest("wlp-1", "wlp_dev_run", "wlp_dev_run_");
    }
    ...
    public void test008() throws Exception {
        ...
        existingContainers.add("wlp_dev_run");
        existingContainers.add("wlp-1_dev_run");
        doNewNameTest("wlp-99", "wlp-2_dev_run", "wlp-2_dev_run_");
    }
    ...
    public void test009() throws Exception {
        ...
        existingContainers.add("foo");
        doNewNameTest("wlp-1_run", "wlp_dev_run", "wlp_dev_run_");
    }
    ...
    public void test010() throws Exception {
        ...
        isUserContainer = true;
        existingContainers.add("wlp_dev_run");
        doNewNameTest("wlp-1_dev_run", "wlp-1_dev_run", "wlp-1_dev_run_");
    }
}
