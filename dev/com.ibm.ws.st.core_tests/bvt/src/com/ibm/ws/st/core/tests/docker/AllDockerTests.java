...
import com.ibm.ws.st.core.tests.jee.JEEPublishEarRemap;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
                      JEEPublishWarNoDDExt.class,
                      JEEPublishEarDDExt.class,
                      JEEPublishEarRemap.class,
})
public class AllDockerTests {
// nothing to see here
}
