...
@TestCaseDescriptor(description = "Test publish works when a web module depends on an external jar", isStable = true)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class Issue303Test2 extends JEETestBase {
    ...
    public void test01_doSetup() throws Exception {
        print("Starting test: Issue303Test2");
        init();
        createRuntime();
        createServer();
        createVM();
        importProjects(new Path("jee/Issue303Test2"), new String[] {
                                                                     "ResourceProject",
                                                                     "WebProject" });
        startServer();
    }
    ...
    public void test02_testServlet1() throws Exception {
        ...
        testPingWebPage("WebProject/TestServlet", "Hello from TestServlet Util2.getInfo");
    ...
    public void test99_doTearDown() throws Exception {
        ...
        wait("Ending test: Issue303Test2\n", 5000);
    }
}