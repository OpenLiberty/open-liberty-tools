...
public class CDIRequiredFeaturesBeansVersion20 extends CDIRequiredFeaturesBase {
    ...
    public static TestSuite suite() {
        ...
        suite.addTest(CDIRequiredFeaturesBeansVersion20.getOrderedTests());
        suite.setName(CDIRequiredFeaturesBeansVersion20.class.getSimpleName());
        return suite;
    }
    ...
    public static TestSuite getOrderedTests() {
        ...
        testSuite.addTest(TestSuite.createTest(CDIRequiredFeaturesBeansVersion20.class, "doSetup"));
        testSuite.addTest(TestSuite.createTest(CDIRequiredFeaturesBeansVersion20.class, "testAddApp"));
        testSuite.addTest(TestSuite.createTest(CDIRequiredFeaturesBeansVersion20.class, "testFeaturesAdded"));
        testSuite.addTest(TestSuite.createTest(CDIRequiredFeaturesBeansVersion20.class, "doTearDown"));
