...
@TestCaseDescriptor(description = "JEE context root test - Web app with context root in xml", isStable = true)
@RunWith(AllTests.class)
public class JEEContextRoot_WAR_With_XML extends JEETestBase {

    public static TestSuite suite() {
        TestSuite suite = new TestSuite();
        suite.addTest(JEEContextRoot_WAR_With_XML.getOrderedTests());
        suite.setName(JEEContextRoot_WAR_With_XML.class.getSimpleName());
        return suite;
    }
    ...
    public static TestSuite getOrderedTests() {
        ...
        testSuite.addTest(TestSuite.createTest(JEEContextRoot_WAR_With_XML.class, "doSetup"));
        testSuite.addTest(TestSuite.createTest(JEEContextRoot_WAR_With_XML.class, "testContextRoot"));
        testSuite.addTest(TestSuite.createTest(JEEContextRoot_WAR_With_XML.class, "doTearDown"));
    ...
    public void doSetup() throws Exception {
        print("Starting test: JEEContextRoot_WAR_With_XML");
        init();
        createRuntime();
        createServer();
        createVM();
    ...
    public void testContextRoot() throws Exception {
        ...
        String expected = "http://localhost:9080/WebExtExampleServlet/*";
    ...
    public void doTearDown() throws Exception {
        ...
        wait("Ending test: JEEContextRoot_WAR_With_XML\n", 5000);
    }
}