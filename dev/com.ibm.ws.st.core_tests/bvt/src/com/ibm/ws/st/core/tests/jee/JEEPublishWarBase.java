...
public abstract class JEEPublishWarBase extends JEETestBase {
    ...
    public void doSetup() throws Exception {
        ...
        importProjects(new Path(getResourceDir()), new String[] { "Util1", "Util2", "Web1", "Web2" }, copyProjects());
    ...
    @Test
    // test add new utility project
    public void addUtilProject() throws Exception {
        updateFile(getUpdatedFileFolder().append("org.eclipse.wst.common.component.S2"),
                   getProject("Web1"), ".settings/org.eclipse.wst.common.component",
                   1);
        wait("Wait 3 seconds before ping.", 3000);
        testPingWebPage("Web1/S1", "web1.S1 U1");
    ...
    @Test
    // test remove utility project
    public void removeUtilProject() throws Exception {
